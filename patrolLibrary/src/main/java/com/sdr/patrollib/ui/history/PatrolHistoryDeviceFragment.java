...
//            PatrolHistoryDevice patrolHistoryDevice = patrolHistoryDeviceRecyclerAdapter.getData().get(position);
//            PatrolHistoryDetailDeviceActivity.start(getContext(), patrolHistoryDevice.getId() + "");
        }
    };
